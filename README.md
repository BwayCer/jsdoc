...
為支持 [`@memberof!`](http://usejsdoc.org/tags-memberof.html)
標籤功能而退版到此 3.5.1 版本。

對此本分叉將進行以下更改：

  * [x] 修復 [3.5.1 版本](https://github.com/jsdoc3/jsdoc/tree/3.5.1)
    `Error: EISDIR: illegal operation on a directory, copyfile '/path/to/file' -> 'out/path/to/folder'`
    的錯誤問題。
